...
export default function HeroBanner({ title, subtitle, rightIcon, className }: HeroBannerProps) {
  ...
  const mapping = [
    ...
    { path: "/dashboard/projects", icon: FolderKanban },
    { path: "/dashboard/experiences", icon: Briefcase },
    { path: "/dashboard/companies", icon: Building },
    { path: "/dashboard/certificates", icon: Award },
    { path: "/dashboard/socials", icon: Share2 },
    { path: "/dashboard/pages", icon: FileText },
