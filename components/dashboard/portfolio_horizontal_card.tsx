...
import ChartBarLabel from "@/components/dashboard/chart_bar_label"
...
export default function PortfolioHorizontalCard({
  portfolio,
  counts,
}: {
  ...
  return (
    <Card className="relative overflow-hidden w-full border-indigo-500/30 bg-linear-to-b from-indigo-500/5 via-transparent to-indigo-500/5">
      ...
      <CardContent>
        <ChartBarLabel items={items} variant="wide" className="w-full" />
      </CardContent>
